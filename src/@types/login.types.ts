...
export interface LoginJSONWebKeySet {
 ...
 */
export interface LoginOauthTokenResponse {
...
export interface InitCibaRequest {
  scope: string;
...
export interface InitCibaResponse {
  auth_req_id?: string;
...
export interface StartLoginUriRequest {
  scope: string;

  redirect_uri: string;
}

export interface CibaTokenNoRedirectRequest {
  auth_req_id: string;
  grant_type: string;
  client_id?: string;
  client_secret?: string;
...
export interface CibaTokenRedirectRequest {
  code: string;
  grant_type: string;
  client_id?: string;
  client_secret?: string;
